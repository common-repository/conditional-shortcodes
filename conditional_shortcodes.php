<?php
/**
 * @package Conditional ShortCodes
 * @author John Leavitt
 * @version 1.0.0
 */
/*
Plugin Name: Conditional ShortCodes
Plugin URI: http://www.hostscope.com/wordpress-plugins/conditional-shortcodes-wordpress-plugin/
Description: Provides a set of shortcodes for conditionally including content in a post based on context.
Author: John Leavitt
Version: 1.0.0
Author URI: http://www.hostscope.com/
*/
...
class jrrl_conditional_shortcode_handler {
  ...
  function is_frontpage_shortcode_handler ($atts, $content="") {
    return $this->generic_handler ($atts, $content, is_frontpage(), '[not_frontpage]');
  }
